...
<div class="carousel fade-carousel slide carousel-background" data-ride="carousel" data-interval="<?= $wallpaper_timer ?>">
    <!-- Overlay -->
...
<!-- <div class="container-fluid px-0">
    <div class="row g-0">
        <div class="col-md-5 header-green">
            ...
            <div id="logo" style="background-image: url(logo/<?= $logo ?>);"></div>
            <h3 class="mb-1 fw-bold">🕌 Masjid Nurul Himmah</h3>
            <p class="mb-0">Jl. Durian Seribu, Bojongsari, Depok • Telp. 0251-8564564</p>
        </div>

        <div class="col-md-7 header-gray d-flex flex-column justify-content-center align-items-end text-end">
            <div id="tanggalHeader" class="fw-semibold mb-2">Kamis, 2 Des 2021 / 27 Rabi’ al-Thani 1443H</div>
            <div class="time-box" id="jamHeader">04:28:11</div>
        </div>
    </div>
</div> -->
...
<script>
    ...
    var app = {
        ...
        initialize: function() {
            ...
            let testTime = moment().add(100, 'seconds');
        ...
        showJadwal: function() {
            ...
            $.each(app.db.prayName, function(k, v) {
                ...
                jadwal += '<div class="row ' + css + '"><div class="waktu-shalat">' + v + '</div><div class="jam-shalat text-center"><span>' + jadwalDipake[k] + jadwalPlusIcon + '</span></div></div>';
            });
